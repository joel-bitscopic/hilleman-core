...
namespace com.bitscopic.hilleman.core.dao.sql
{
    public class MockDataReader : IDataReader
    {
        ...
        {
            _results.Dispose();
            // change cleanup here as needed! currently this is just a DataTable wrapper so no real cleanup required
        }
        ...
        public int GetOrdinal(string name)
        {
            ...
            {
                throw new ArgumentException(name + " column was not found in the query results");
            }
